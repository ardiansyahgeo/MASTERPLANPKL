var size = 0;
var placement = 'point';
function categories_RTH_RDTR_DKI_3(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'H.1':
...
var style_RTH_RDTR_DKI_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("SUB_ZONA");
    var labelText = "";
    size = 0;
...
var style = categories_RTH_RDTR_DKI_3(feature, value, size, resolution, labelText,
